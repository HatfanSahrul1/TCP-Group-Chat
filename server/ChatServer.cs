    ...
    public class ChatServer : IDisposable
    {
        ...
        public async Task StartAsync(int port = 8888)
        {
            try
            {
                ...
                OnServerMessage($"===============================================");
                OnServerMessage($"🌐 WhatsApp95 Chat Server Started");
                OnServerMessage($"===============================================");
                OnServerMessage($"📡 Server Port: {port}");
                OnServerMessage($"🔗 Available IP Addresses:");
                OnServerMessage(localIPs);
                OnServerMessage($"===============================================");
                OnServerMessage($"💡 Connect from other devices using:");
                OnServerMessage($"   IP: [Your Local IP]  Port: {port}");
                OnServerMessage($"===============================================");
        ...
        private string GetLocalIPAddresses()
        {
            ...
            {
                sb.AppendLine($"   ❌ Error getting IP: {ex.Message}");
